...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if ((tempRecuperacion <= 0)&&(vidas < 5) && (vidas > 0))
            {
            ...
            if (vidas <= 0)
            {
                ...
                mensajeDerrota.GetComponent<Animator>().SetTrigger("muerte");
            }
            ...
            if (vidas < 5) tempRecuperacion -= Time.deltaTime;
